const cardData = [
    ...
    { name: 'abcdaveabcd abcdabcd', title: 'Software Engineer - 1', company: 'Company Logo', img: "https://via.placeholder.com/50" },
    { name: 'abcdaveabcd asdasd abcdabcd', title: 'Software Engineer - 1', company: 'Company Logo', img: "https://via.placeholder.com/50" },
    { name: 'asdik asdasd abcdabcd', title: 'Software Engineer - 1', company: 'Company Logo', img: "https://via.placeholder.com/50" },
];
